...
def get_translation(artist: str, song_name: str) -> Tuple[Dict[str, str], List[Tuple[str, str]], Optional[str]]:
    """
    Obtém a tradução verso a verso da música no Letras.mus.br.
    Retorna:
      - lyrics_dict: { "linha original": "linha traduzida" }
      - lyrics_list: [("linha original", "linha traduzida"), ...]
    ...
    log(f"Acessando página de tradução: {url_translation}")
